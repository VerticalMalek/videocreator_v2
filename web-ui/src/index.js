...
const updateOrderWithUploadedFile = (key) => {
    ORDER_PHOTOS.push(key);
    console.log('photos');
...
const registerUserRequest = {
    email: 'malek.piotr96@gmail.com',
    pw: 'test12345',
    website: 'testowanko322311.jkan.pl',
};
...
uploadFilesBtn.addEventListener('click', () => {
    ...
    toBeUploaded.forEach(file => {
        uploadToS3(
            ...
            .then(key => updateOrderWithUploadedFile(key))
...
placeOrderBtn.addEventListener('click', () => {
    ...
    getAccessToken()
        .then(token => orderAnimation(token, order_request))
